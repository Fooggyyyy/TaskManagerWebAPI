...
#pragma warning disable CS9113
    public class ExitUserCommandHandler(IUserRepository UserRepository, IMapper Mapper, IValidator Validator, IJwtService JwtService)
        : IRequestHandler<ExitUserCommand, Unit>
    {
        public Task<Unit> Handle(ExitUserCommand request, CancellationToken cancellationToken)
        {
